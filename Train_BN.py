...
parser = ArgumentParser(description='LFM_BN')
...
parser.add_argument('--frft_order', type=float, default=0.1, help='the fractional Fourier transform order')
...
model_name = f"BN{frft_order}_{end_epoch}_layer_{layer_num}"
