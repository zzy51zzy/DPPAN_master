...
parser = ArgumentParser(description='LFM_BN+CAdaIN1(AIO)')
...
parser.add_argument('--image_dir', type=str, default='data/train/BSD6000', help='training data directory')
...
class DUNet(torch.nn.Module):
    """(3) BN+CAdaIN1 (AIO): Two parameters of AdaIN are generated
    by a fully connected layer with physical parameters (such as p)."""
...
model_name = f"BN+CAdaIN1(AIO)_{end_epoch}_layer_{layer_num}"
